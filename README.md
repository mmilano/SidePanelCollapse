...
Everything in the `/src_demo` directory is for the demonstration examples that can be built and viewed. These demos are derived from a larger site I developed which is built around a static page generation process using [Panini][Panini]/handlebars.js. 
